...
docker tag datascience/entity_formation_string_comparison_model_v2:latest 741242253094.dkr.ecr.us-west-2.amazonaws.com/datascience/entity_formation_string_comparison_model:$TAG
