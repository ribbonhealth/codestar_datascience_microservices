...
docker tag datascience/entity_formation_string_comparison_model:latest 404889086824.dkr.ecr.us-west-2.amazonaws.com/datascience/entity_formation_string_comparison_model:$TAG
