...
class ModelOutput(BaseModel):
    """Model output data schema."""

    location_correctness_score_bin: Optional[int]
    location_correctness_score: Optional[float]
    phone_scores: Optional[List[Dict]]
...
class ScoringService(object):
    ...
    def parse_input_data(cls, input_data, cols):
        google_place_result_flag = True if 'google_place_result' in input_data['elements'] and input_data['elements']['google_place_result'] is not None else False
        input_data['google_findplace_address_components'] = parse_address_components(input_data['elements']['google_place_result']
                                                                                     ) if google_place_result_flag else None
        ...
        input_data['permanently_closed_flag'] = int(input_data['elements']['permanently_closed_flag']) if 'permanently_closed_flag' in input_data[
            'elements'] else 0
        input_data['rating'] = int('rating' in input_data['elements']['google_place_result']) if google_place_result_flag else 0
        input_data['photo_count'] = len(input_data['elements']['google_place_result']['photos']) if google_place_result_flag and 'photos' in input_data['elements']['google_place_result'] else 0
        input_data['reviews_count'] = len(input_data['elements']['google_place_result']['reviews']) if google_place_result_flag and 'reviews' in input_data['elements']['google_place_result'] else 0
    ...
    def predict_phone_confidences(cls, input_data):
        ...
        for phone in parsed_data['elements']['phone_numbers']:
            ...
            parsed_data['findplace_phone_scrubbed'] = str_regex.sub('', parsed_data['elements']['google_place_result'][
                'formatted_phone_number']) if 'google_place_result' in parsed_data['elements'] and parsed_data['elements']['google_place_result'] is not None and 'formatted_phone_number' in parsed_data['elements'][
...
def handler(event, context):
    ...
    input = dict(ModelInput.parse_raw(event['body']))
    result = ScoringService.predict_location_correctness(input)
    confidence_bin = None
    ...
    if result >= 0.79:
        ...
        confidence_bin = 1
    phone_scores = ScoringService.predict_phone_confidences(input)
    phone_scores.sort(key=lambda x: x['score'], reverse=True)
    resp = ModelOutput(location_correctness_score=result,
                         location_correctness_score_bin=confidence_bin,
                         phone_scores=phone_scores).dict()
    return {'statusCode': 200,
            'body': json.dumps(resp),
            'headers': {'Content-Type': 'application/json'}}

# input with google place result
...
# input with no google place result
# input = '{"address_components": {"subpremise": null, "street_number": "55", "intersection": null, "route": "Horizon Dr", "city": "Huntington", "state": "NY", "zip": "11743", "country": "US", "is_tokenized": true, "formatted_address": "55 Horizon Dr, Huntington, NY 11743, US"}, "resolve_method": "score_location","elements": {"google_place_result": null, "sources": ["9"], "phone_numbers": ["6319208088", "6319208000"],"raw_phone_numbers": ["6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208000", "6319208000","6319208000", "6319208000", "6319208000", "6319208088"],"google_name_cleansed": "", "google_chosen_name_similarity": null,"permanently_closed_flag": false, "google_types": []}}'
